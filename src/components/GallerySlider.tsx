    ...
    <section id="gallery" className="py-16 md:py-24 bg-[#15191F] text-[#F7F7F5] px-4 sm:px-6 md:px-10 overflow-hidden border-t border-[#2A3038]">
      <div className="max-w-7xl mx-auto">
        ...
        >
              ...
              return (
                <div
                  ...
                  className={`relative overflow-hidden rounded-2xl transition-all duration-500 cursor-pointer flex-shrink-0 ${
                    isCenter
                      ? 'w-[55%] sm:w-[60%] h-full shadow-2xl border-2 border-[#F97316]/50 z-10'
                      : 'w-[20%] sm:w-[18%] h-[75%] opacity-50 hover:opacity-70 shadow-md border border-slate-200'
                  }`}
                >
                  <img
                    src={images[imgIdx]}
                  ...
                  />
                  {isCenter && (
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0f172A]/50 via-transparent to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-6">
                      <span className="inline-flex items-center gap-1.5 bg-white text-[#0f172A] text-xs font-bold px-4 py-2 rounded-full shadow-md">
          ...
          <button
            onClick={prev}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 sm:-translate-x-4 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#0f172A] hover:bg-[#1e293b] text-white shadow-lg flex items-center justify-center transition-all z-20 cursor-pointer border border-slate-700"
          ...
          <button
            onClick={next}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 sm:translate-x-4 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#0f172A] hover:bg-[#1e293b] text-white shadow-lg flex items-center justify-center transition-all z-20 cursor-pointer border border-slate-700"
          ...
          {images.map((src, i) => (
            <button
              ...
              className={`flex-shrink-0 w-16 h-12 sm:w-20 sm:h-14 rounded-lg overflow-hidden border-2 transition-all duration-300 cursor-pointer ${
                i === activeIdx
                  ? 'border-[#F97316] opacity-100 scale-105 shadow-sm'
