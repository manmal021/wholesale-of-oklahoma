  ...
  return (
    <div className="min-h-screen bg-[#0B0D10] flex flex-col justify-center py-12 sm:px-6 lg:px-8 text-[#F7F7F5]">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <div className="w-14 h-14 rounded-2xl bg-[#FF6B00]/15 border border-[#FF6B00]/30 flex items-center justify-center text-[#FF6B00] mx-auto shadow-xl mb-4">
          ...
          {token ? (
            ...
            isSuccess ? (
              <div className="text-center py-6 space-y-4">
                ...
                <h3 className="text-xl font-bold text-[#F7F7F5]">Password Reset Complete!</h3>
                ...
                <div className="pt-3">
                  <a
                    href="/"
                    className="inline-block px-6 py-3 rounded-xl bg-[#FF6B00] hover:bg-[#E05E00] text-white font-bold text-xs uppercase tracking-wider transition-colors shadow-md"
                  >
            ...
            requestSent ? (
              <div className="text-center py-6 space-y-4">
                ...
                <h3 className="text-xl font-bold text-[#F7F7F5]">Instructions Dispatched</h3>
                <p className="text-xs text-[#B8BDC5] leading-relaxed">
                ...
                <div className="pt-2">
                  <a
                    href="/"
                    className="inline-block px-5 py-2.5 rounded-xl bg-[#1B2027] hover:bg-[#2A3038] text-xs font-semibold text-[#F7F7F5] border border-[#2A3038]"
                  >
              ...
              <form onSubmit={handleRequestReset} className="space-y-5">
                ...
                <div className="text-center pt-2">
                  <a
                    href="/"
                    className="text-xs text-[#858C96] hover:text-[#F7F7F5] inline-flex items-center gap-1 transition-colors"
                  >
