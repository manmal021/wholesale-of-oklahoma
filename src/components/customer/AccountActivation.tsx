  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col justify-center py-12 sm:px-6 lg:px-8 text-slate-900">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <div className="w-14 h-14 rounded-2xl bg-emerald-50 border border-emerald-200 flex items-center justify-center text-emerald-600 mx-auto shadow-xs mb-4">
        ...
        <div className="bg-white py-8 px-6 sm:px-10 border border-slate-200 rounded-3xl shadow-xl space-y-6">
          {isVerifying ? (
            <div className="py-12 text-center space-y-3">
              ...
              <p className="text-xs text-slate-500">Verifying your activation invitation...</p>
            </div>
          ) : !isValidToken ? (
            <div className="text-center py-6 space-y-4">
              ...
              <h3 className="text-lg font-bold text-slate-900">Link Expired or Already Used</h3>
              ...
              <div className="pt-2">
                <a
                  href="/"
                  className="inline-block px-5 py-2.5 rounded-xl bg-[#FF6B00] hover:bg-[#E05E00] text-white font-bold text-xs uppercase tracking-wider transition-colors shadow-xs"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 text-xs space-y-1">
                <span className="text-slate-500 block">Activating Wholesale Account:</span>
                <span className="text-slate-900 font-mono font-bold block">{customerEmail}</span>
              </div>
