...
export default function ReviewSlider() {
  ...
  return (
    <section id="reviews" className="py-16 md:py-24 bg-[#0f172A] text-white px-4 sm:px-6 md:px-10 relative overflow-hidden border-t border-slate-800">
      {/* Decorative vector backgrounds & glowing soft lights */}
      <div className="absolute inset-x-0 bottom-0 top-1/2 bg-gradient-to-t from-black/30 to-transparent pointer-events-none" />
      <div className="absolute top-[-20%] left-[-10%] w-[400px] h-[400px] rounded-full bg-[#F97316] opacity-15 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-5%] w-[400px] h-[400px] rounded-full bg-slate-700 opacity-20 blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center gap-1 bg-white/10 text-[#F97316] border border-[#F97316]/30 text-xs font-semibold px-3 py-1 rounded-full">
              <MessageSquare className="w-3.5 h-3.5" />
              GOOGLE MAPS VERIFIED FEEDBACK
            </div>
            <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-white leading-tight">
              Flawless <span className="text-[#F97316]">5.0 Star</span> reputation
            </h2>
            ...
            <div className="p-5 bg-white/5 border border-white/10 rounded-[24px] space-y-4">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <span className="text-xs uppercase font-semibold text-slate-400 tracking-wider">Total reviews</span>
                  <p className="text-lg font-bold text-[#F97316]">{reviews.length + 9} Satisfied Audits</p>
                </div>
              </div>
            ...
            <button
              ...
              className="bg-[#F97316] hover:bg-[#ea580c] text-white font-bold text-xs uppercase px-6 py-3.5 rounded-full shadow-lg transition-all tracking-wider inline-flex items-center gap-2 cursor-pointer"
            >
          ...
          <div className="lg:col-span-7 flex flex-col justify-between h-full space-y-6">
            <div className="relative min-h-[300px] flex flex-col justify-between p-6 sm:p-10 bg-white/5 border border-white/10 rounded-[32px] backdrop-blur-md">
              ...
              <div className="space-y-6">
                <span className="text-[#F97316] font-mono text-xs uppercase tracking-widest block font-bold">
                  Testimonial {activeIdx + 1} of {reviews.length}
                </span>

                <blockquote className="text-lg sm:text-2xl font-light text-slate-100 leading-relaxed italic">
                  "{currentReview.body}"
                </blockquote>
              </div>
              ...
              <div className="mt-8 flex items-center justify-between pt-6 border-t border-white/10 gap-4 flex-wrap">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-[#F97316]/20 flex items-center justify-center border border-[#F97316]/30 text-[#F97316]">
                    <User className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="font-bold text-white text-sm sm:text-base">{currentReview.author}</h4>
                    <span className="text-xs text-slate-400 block">{currentReview.role}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  {currentReview.verified && (
                    <span className="bg-[#F97316]/10 text-[#F97316] text-[9px] font-semibold px-2 py-0.5 rounded border border-[#F97316]/20">
            ...
            <div className="flex items-center justify-end gap-3 self-end">
              <button
                ...
                className="w-10 h-10 rounded-full border border-white/20 hover:border-white/60 hover:bg-white/10 transition-all flex items-center justify-center text-white text-sm cursor-pointer"
      ...
      {writeOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 text-[#0f172A]">
          <div className="absolute inset-0 bg-[#0f172A]/70 backdrop-blur-sm" onClick={() => setWriteOpen(false)} />
          <div className="relative bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="bg-[#0f172A] text-white p-6 relative border-b border-slate-800">
              <span className="text-xs uppercase font-semibold text-[#F97316] tracking-wider block">Write a Map Review</span>
              <h4 className="text-xl sm:text-2xl font-bold mt-1">Wholesale of Oklahoma Feedback</h4>
              <button
                onClick={() => setWriteOpen(false)}
                className="absolute top-4 right-4 text-white/85 hover:text-white text-lg font-bold p-1 cursor-pointer"
            ...
            <form onSubmit={handleCreateReview} className="p-6 space-y-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full border border-slate-300 rounded-xl px-3 py-2 text-sm text-[#0f172A] focus:outline-none focus:border-[#F97316]"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1.5 py-1">
                  ...
                  <span className="text-xs font-bold text-[#F97316] ml-2">({newRating}.0 / 5.0 Stars)</span>
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full border border-slate-300 rounded-xl px-3 py-2 text-sm text-[#0f172A] focus:outline-none focus:border-[#F97316] resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-3 bg-[#F97316] hover:bg-[#ea580c] text-white font-semibold text-xs rounded-full uppercase tracking-wider transition-colors disabled:opacity-50 cursor-pointer shadow-md"
              >
      ...
      {toastVisible && (
        <div className="fixed bottom-6 right-6 z-50 bg-[#0f172A] border border-[#F97316]/30 text-white px-6 py-4 rounded-2xl shadow-xl flex items-center gap-3 animate-in slide-in-from-bottom-6 duration-300">
          <CheckCircle2 className="w-5 h-5 text-[#F97316] shrink-0" />
          <div>
            <h5 className="font-semibold text-sm">Review Appended</h5>
            <p className="text-xs text-slate-400">Thank you for your review on Wholesale of Oklahoma!</p>
          </div>
        </div>
      )}
    </section>
