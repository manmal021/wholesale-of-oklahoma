...
export const PRODUCTS: WholesaleProduct[] = [
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    puffs: '15,000 Puffs',
    nicotine: '5%',
    features: ['Dual Mesh Coil', 'Full Screen Display', 'Pulse Mode Boost', 'Top Smoke Shop Turnover'],
  ...
  },
  {
    ...
    features: ['SSS Leak-Resistant Tech', 'Clamshell Top Fill', 'Corex Heating Tech', 'Essential Smoke Shop Restock'],
  ...
  },
  {
    ...
    size: '100ml Bottle',
    nicotine: '0mg / 3mg / 6mg',
    features: ['Famous Cookie & Dessert Line', 'Rich Dense Cloud Production', 'Top Smoke Shop Restock', 'Certified Wholesale Batch'],
  ...
  // ───────────────────────────────────────────────────────────────────────────
  {
    ...
    features: ['Unrefined Natural Plant Fibers', 'Criss-Cross Watermark Anti-Run Tech', 'Acacia Gumline', 'Every Smoke Shop Must-Have'],
