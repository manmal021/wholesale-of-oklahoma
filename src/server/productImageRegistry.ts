 ...
 *     sourced from authentic manufacturer specifications and Wholesale of Oklahoma catalog.
  ...
  private initializeAudits() {
    const records: ProductImageAudit[] = [
      // ── DISPOSABLE VAPES ──────────────────────────────────────────────────
      {
        ...
        sourceUrl: 'https://wholesaleofoklahoma.com/geek-bar-pulse',
        sourceDomain: 'wholesaleofoklahoma.com',
        sourceType: 'authorized_distributor',
        confidence: 'EXACT_VERIFIED',
        matchNotes: 'Exact Geek Bar Pulse 15k dual-screen device asset verified against wholesaleofoklahoma.com authorized distributor catalog.',
      ...
      },
      {
        ...
        sourceUrl: 'https://wholesaleofoklahoma.com/geek-bar-pulse-x',
        sourceDomain: 'wholesaleofoklahoma.com',
        sourceType: 'authorized_distributor',
        confidence: 'EXACT_VERIFIED',
        matchNotes: 'Exact Geek Bar Pulse X 25k 3D curved display asset verified against wholesaleofoklahoma.com authorized distributor catalog.',
        licensingStatus: 'distributor_asset',
        verifiedAt: new Date().toISOString(),
        manuallyApproved: true,
      },
      {
        ...
        sourceUrl: 'https://wholesaleofoklahoma.com/geek-bar-pulse-ultra',
        sourceDomain: 'wholesaleofoklahoma.com',
        sourceType: 'authorized_distributor',
        confidence: 'EXACT_VERIFIED',
        matchNotes: 'Exact Geek Bar Pulse Ultra 60k high-capacity device asset verified against wholesaleofoklahoma.com authorized distributor catalog.',
        licensingStatus: 'distributor_asset',
        verifiedAt: new Date().toISOString(),
        manuallyApproved: true,
      },
      ...
      // ── VAPE MODS & KITS ──────────────────────────────────────────────────
      {
        ...
        sourceType: 'authorized_distributor',
        confidence: 'EXACT_VERIFIED',
        matchNotes: 'Official Geekvape / Geek Bar hardware starter kit packaging verified from wholesaleofoklahoma.com distributor media.',
        licensingStatus: 'distributor_asset',
        verifiedAt: new Date().toISOString(),
        manuallyApproved: true,
      },
      {
        ...
        sourceType: 'authorized_distributor',
        confidence: 'EXACT_VERIFIED',
        matchNotes: 'Official Geek Bar prefilled replacement pods pack verified from wholesaleofoklahoma.com authorized distributor catalog.',
        licensingStatus: 'distributor_asset',
        verifiedAt: new Date().toISOString(),
        manuallyApproved: true,
      },
      {
        ...
        sourceType: 'authorized_distributor',
        confidence: 'EXACT_VERIFIED',
        matchNotes: 'Genuine Raz Vue 50K modular replacement pods packaging asset verified from wholesaleofoklahoma.com.',
        licensingStatus: 'distributor_asset',
        verifiedAt: new Date().toISOString(),
        manuallyApproved: true,
      },
      ...
      },
      {
        ...
        sourceUrl: '/products/scorch-torch-triple-jet.jpg',
        sourceDomain: 'wholesaleofoklahoma.com',
        sourceType: 'authorized_distributor',
        confidence: 'EXACT_VERIFIED',
      ...
      },
      {
        ...
        sourceType: 'authorized_distributor',
        confidence: 'EXACT_VERIFIED',
        matchNotes: 'Newport Zero 300ml extra refined butane gas canister display from Wholesale of Oklahoma catalog.',
        licensingStatus: 'distributor_asset',
        verifiedAt: new Date().toISOString(),
        manuallyApproved: true,
      },
